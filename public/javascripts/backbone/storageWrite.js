window.StorageWriteView = Backbone.View.extend({
	el : '#target',
	...
	initialize : function() {
		...
		this.chartView1.metric = 'disk_write_bytes';
		this.chartView2.metric = 'disk_write_ops';
		this.chartView1.title = 'Disk Write Bytes';
		this.chartView2.title = 'Disk Write Ops';
		...
		this.statView1.metric = 'disk_write_bytes';
		this.statView2.metric = 'disk_write_ops';
