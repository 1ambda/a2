...
window.ChartView = Backbone.View.extend({
	initialize : function() {
		this.chart = createChart(null, null);
	...
	render : function() {
		...
		this.chart.dataProvider = createDummyResources();
		this.chart.validateData();
		this.chart.write(this.target);
		this.chart.validateNow();
	},
	
	triggerFetch: function(metric, instance, time) {
		this.collection.url = '/resources/' + metric + '/' + instance + '/' + time;
		console.log(this.collection.url);
	},
	
	drawChart: function(metric, instance, time) {
	},
