window.NetworkView = Backbone.View.extend({
	...
	initialize : function() {
		...
		this.chartView1.metric = 'network_in';
		this.chartView2.metric = 'network_out';
		this.chartView1.title = 'Network In';
		this.chartView2.title = 'network Out';
		...
		this.statView1.metric = this.chartView1.metric;
		this.statView2.metric = this.chartView2.metric;
