...
AmCharts.addZeroes = function(a, b, c) {
	...
	return a[1].length < c ? (a[1] += "0", AmCharts.addZeroes(a[0] + b + a[1], b, c)) :
	void 0 !== a[1] ? a[0] + b + a[1] : a[0]
};
...
AmCharts.copyProperties = function(a, b) {
	for (var c in a)a.hasOwnProperty(c) && "events" != c &&
	void 0 !== a[c] && "function" != typeof a[c] && "cname" != c && (b[c] = a[c])
};
	...
	draw : function() {
		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))
			...
			if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
				...
				for ( d = p; d < r; d += n)
					if ( p = q * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
...
AmCharts.RecItem = AmCharts.Class({
	construct : function(a, b, c, d, e, f, g, h, k, l) {
		...
		g ? ( I = !0, isNaN(g.tickLength) || ( s = g.tickLength),
		void 0 != g.lineColor && ( C = g.lineColor),
		void 0 != g.color && ( p = g.color), isNaN(g.lineAlpha) || ( w = g.lineAlpha), isNaN(g.dashLength) || ( y = g.dashLength), isNaN(g.lineThickness) || ( A = g.lineThickness), !0 === g.inside && ( S = !0), isNaN(g.labelRotation) || ( B = g.labelRotation), isNaN(g.fontSize) || ( n = g.fontSize), g.position && ( ea = g.position)) : "" === c && ( s = 0);
		W = "start";
		e && ( W = "middle");
...
AmCharts.AmGraph = AmCharts.Class({
	...
	createSerialGraph : function() {
		this.dashLengthSwitched = this.fillColorsSwitched = this.lineColorSwitched =
		void 0;
		...
		if (!da && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Ka ||
		void 0 != Aa)) {
			var Ga = ea;
			Ga > f.max && ( Ga = f.max);
			Ga < f.min && ( Ga = f.min);
		...
		for ( H = Z; H <= S; H++) {
			...
			x.index = H;
			var M, N, K, ba, ja = NaN, F = NaN, E = NaN, Q = NaN, O = NaN, Oa = NaN, Ba = NaN, Pa = NaN, Ca = NaN, ca = NaN, ga = NaN, pa = NaN, qa = NaN, R = NaN, fb = NaN, gb = NaN, la = NaN, na =
			void 0, za = Kb, Qa = La, ra = oa, ma, sa, Ra = this.pattern;
			...
			if (ta) {
				...
				R < la && (x.isNegative = !0, Ka && ( za = Ka), Ma && ( Qa = Ma),
				void 0 != Aa && ( ra = Aa));
				switch(g) {
					case "line":
						isNaN(R) ? u || (this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = []) : (x.isNegative = R < ea ? !0 : !1, q.push(F), t.push(E), ca = F, ga = E, pa = F, qa = E, !Na || isNaN(O) || isNaN(Q) || (T.push(Q), U.push(O)),
						void 0 == x.lineColor &&
						void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U), q = [F], t = [E], T = [], U = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength));
						break;
					case "smoothedLine":
						isNaN(R) ? u || (this.drawSmoothedGraph(q, t, T, U), q = [], t = [], T = [], U = []) : (x.isNegative = R < ea ? !0 : !1, q.push(F), t.push(E), ca = F, ga = E, pa = F, qa = E, !Na || isNaN(O) || isNaN(Q) || (T.push(Q), U.push(O)),
						void 0 == x.lineColor &&
						void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawSmoothedGraph(q, t, T, U), q = [F], t = [E], T = [], U = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength));
						break;
					case "step":
						if (!isNaN(R))
							x.isNegative = R < ea ? !0 : !1,
							void 0 == x.lineColor &&
							void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(v) || (q.push(v), t.push(E - ka)), t.push(E - ka), q.push(F), t.push(E + ua), q.push(F), !Na || isNaN(O) || isNaN(Q) || (T.push(w), U.push(O - ka), T.push(Q), U.push(O - ka), T.push(Q), U.push(O + ua))) : (isNaN(s) || (t.push(s), q.push(v), t.push(s), q.push(F - ka)), q.push(F - ka), t.push(E), q.push(F + ua), t.push(E), !Na || isNaN(O) || isNaN(Q) || (T.push(Q - ka), U.push(A), T.push(Q - ka), U.push(O), T.push(Q + ua), U.push(O))), v = F, s = E, w = Q, A = O, ca = F, ga = E, pa = F, qa = E, vb && ( v = s = NaN, this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = []);
						else if (!u) {
						...
						if (!isNaN(R)) {
							...
							if (!(R < xb && la < xb || R > yb && la > yb))
								if (n) {
									...
									if (N < l && 0 < K && ( na = new AmCharts.Cuboid(e, ba, K, z - a.d3x, J - a.d3y, za, Qa, L, ma, V, ha, r, n, Y, Ra), "bottom" != B && "inside" != B && "middle" != B))
									...
									if (M < k + $ * z && 0 < K)
										if ( na = new AmCharts.Cuboid(e, K, ba, z - a.d3x, J - a.d3y, za, Qa, L, ma, this.lineAlpha, ha, r, n, Y, Ra), 0 > R && "middle" != B && "inside" != B)
											B = "bottom";
					...
					case "candlestick":
						if (!isNaN(la) && !isNaN(R)) {
							...
							if (n) {
								...
								!isNaN(Ca) && !isNaN(Ba) && F < k && 0 < F && ( $a = AmCharts.line(e, [F, F], lb, ma, V, L), ib = AmCharts.line(e, [F, F], mb, ma, V, L))
							}
					...
					case "ohlc":
						if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
							...
							var nb, ob, pb;
							if (n) {
								var qb = E - h / 2, qb = AmCharts.fitToBounds(qb, 0, l), zb = AmCharts.fitToBounds(E, 0, l), rb = E + h / 2, rb = AmCharts.fitToBounds(rb, 0, l);
	...
	drawSmoothedGraph : function(a, b, c, d) {
		if (1 < a.length) {
			...
			e.push(h);
			e.push(g);
			var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n = this.lineColorR, p = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, q = this.negativeFillAlphas, t = this.baseCoord, v = this.lineColorSwitched;
			v && ( n = v);
			...
			0 < m && ( k = a.join(";").split(";"), n = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), k = a.concat(c), n = b.concat(d)) : (this.rotate ? (l += " L" + t + "," + b[b.length - 1], l += " L" + t + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + t, l += " L" + a[0] + "," + t), l += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, k, n, NaN, 0, 0, p, m, e, l), c.path.pattern(this.pattern), g.push(c.path), u ||
			void 0 !== r) && (q || ( q = m), u || ( u = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, u, q, e, l), a.path.pattern(this.pattern), h.push(a.path));
			this.applyMask(h, g)
		}
	},
	...
	createBullet : function(a, b, c, d) {
		...
		a.isNegative &&
		void 0 !== this.bulletColorNegative && ( l = this.bulletColorNegative);
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	updateCursor : function(a, b) {
		...
		if (this.enabled) {
			...
			this.fireMoved();
			if (p) {
				var r = p.x[f.id], u = c.rotate, q = f.inside, t = this.stepWidth, v = this.categoryBalloon, s = this.firstTime, w = this.lastTime, A = this.cursorPosition, C = f.position, y = this.zooming, z = this.panning, J = c.graphs, I = f.axisThickness;
					...
					if (this.forceShow = !1, z) {
						...
						if (this.oneBalloonOnly) {
							...
							for ( w = 0; w < J.length; w++)
								f = J[w], f.showBalloon && !f.hidden && f.balloonText && ( v = p.axes[f.valueAxis.id].graphs[f.id], s = v.y, isNaN(s) || ( u ? Math.abs(d - s) < h && ( h = Math.abs(d - s), B = f) : Math.abs(e - s) < h && ( h = Math.abs(e - s), B = f)));
						...
						if (a != this.previousIndex || B != this.previousMostCloseGraph)
							if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
								...
								for ( w = 0; w < J.length; w++)
									if ( f = J[w], (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText && ("step" == f.type && "left" == f.stepDirection && ( p = this.data[a + 1]), p)) {
										...
										if (!isNaN(s)) {
											...
											if (u) {
												...
												t = !1;
											t && (1 != this.graphBulletSize && AmCharts.isModern && ( t = v.bulletGraphics) && (t.getBBox(), t.translate(v.bx, v.by, this.graphBulletSize), this.resizedBullets.push(v)), t = f.valueBalloon, C = c.getBalloonColor(f, v), t.setBounds(k, l, k + m, l + n), t.pointerOrientation = "H", t.changeColor(C),
...
AmCharts.AmBalloon = AmCharts.Class({
	...
	followCursor : function(a) {
		var b = this;
		(b.follow = a) ? (b.pShowBullet = b.showBullet, b.showBullet = !1) :
...
AmCharts.AmCoordinateChart = AmCharts.Class({
	...
	getBalloonColor : function(a, b, c) {
		...
		c && ( e = d);
		c = a.fillColorsR;
		"object" == typeof c ? d = c[0] :
		void 0 !== c && ( d = c);
		b.isNegative && ( c = a.negativeLineColor, a = a.negativeFillColors, "object" == typeof a ? c = a[0] :
		void 0 !== a && ( c = a),
		void 0 !== c && ( d = c));
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
	...
	0 < k && ( u ? ( B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k), I || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + s + "," + (w + k) + "," + A + "," + (C + k)), B += " L" + y + "," + (t + k), 0 < h && (I || (B += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + y + "," + (k + t) + "," + q + "," + (k + v)))) : ( B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k) + (" A" + f + "," + g + ",0," + J + ",1," + A + "," + (C + k) + " L" + y + "," + (t + k)), 0 < h && (B += " A" + h + "," + r + ",0," + J + ",0," + q + "," + (v + k))), B += " Z", B = a.path(B,
	void 0,
	void 0, "1000,1000").attr(z), d.push(B), B = a.path(" M" + q + "," + v + " L" + q + "," + (v + k) + " L" + s + "," + (w + k) + " L" + s + "," + w + " L" + q + "," + v + " Z",
	void 0,
	void 0, "1000,1000").attr(z), k = a.path(" M" + A + "," + C + " L" + A + "," + (C + k) + " L" + y + "," + (t + k) + " L" + y + "," + t + " L" + A + "," + C + " Z",
	void 0,
	void 0, "1000,1000").attr(z), d.push(B), d.push(k));
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend : function() {
		...
		c =
		void 0 !== c ? AmCharts.toCoordinate(c, d) : a.realWidth;
	...
	createEntry : function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			if (this.useGraphSettings)
				if ( m = a.type, this.switchType =
					void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
				...
				h ? (b.path && ( h = b.path + h), g = k.image(h, 0, 0, l, l)) : ( g = this.createMarker(c, d, e,
				void 0,
				void 0,
				void 0,
				void 0, g)) && g.translate(l / 2, l / 2);
			...
			f = this.color;
			a.showBalloon && this.textClickEnabled &&
			void 0 !== this.selectedColor && ( f = this.selectedColor);
